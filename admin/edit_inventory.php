		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="hidden" class="form-control" id="exampleInputEmail1" placeholder="Contoh : Kg atau gram" name="kd_Stok" value="<?= $row['kode_bk']; ?>">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label for="exampleInputEmail1">Nama Stok</label>
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Stok" name="nama" value="<?= $row['nama']; ?>">
				</div>
			</div>
		</div>
