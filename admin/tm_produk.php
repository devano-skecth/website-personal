...
$num = isset($data['kode_produk']) ? substr($data['kode_produk'], 1, 4) : '0000';
$add = (int) $num + 1;
if(strlen($add) == 1){
	$format = "P000".$add;
...
<div class="container">
	...
	<form action="proses/tm_produk.php" method="POST" enctype="multipart/form-data">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<h4>Pilih Stok yang hanya dibutuhkan untuk produk</h4>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="Stok[]" class="form-control" placeholder="Masukkan Kode Stok">
							</div>
						</div>
