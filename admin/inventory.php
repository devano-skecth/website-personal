...
<div class="container">
	<h2 style=" width: 100%; border-bottom: 4px solid gray"><b>Stok</b></h2>
	...
	<a href="tm_inventory.php" class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i> Tambah Stok</a>
</div>
