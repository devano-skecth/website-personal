 ...
 ?>
	...
	<div class="row">
		<div class="col-md-4 bg-danger" style="padding:10px;">
			<h4>Kekurangan Stok </h4>
			<h5 style="color: red;font-weight: bold;">Silahkan Tambah Stok Stok dibawah ini : </h5>
			<table class="table table-striped">
				<tr>
					<th>No</th>
					<th>Stok</th>
	...
	<?php 
if (isset($nama_Stok) && is_array($nama_Stok)) {
    $arr = array_values(array_unique($nama_Stok));
...
?>
    <tr>
        <td colspan="2">Tidak ada data kekurangan stok.</td>
    </tr>
<?php 
}
?>
